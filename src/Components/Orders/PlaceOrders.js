          ...
          handler: async function (response) {
            ...
            try {
              ...
              if (verify.data.status) {
                ...
                if (verify.data.isCoupon) {
                  setIsCoupon(true);
                  setCouponData(verify.data.coupon);
                }
              } else {
          ...
          <div className="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6 mb-6 border border-gray-200 dark:border-gray-700">
            ...
            <div className="flex space-x-2 mb-3">
              <input
                ...
                placeholder={
                  appliedCoupon
                    ? "Remove current coupon to apply new one"
                    : "Enter coupon code"
                }
                disabled={appliedCoupon}
                className="flex-1 px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white disabled:bg-gray-100 dark:disabled:bg-gray-600 disabled:cursor-not-allowed"
              />
              <button
                type="button"
                onClick={handleCouponApply}
                disabled={appliedCoupon}
                className="bg-purple-600 hover:bg-purple-700 text-white px-6 py-2 rounded-lg font-medium transition-colors duration-200 flex items-center gap-2 disabled:bg-gray-400 disabled:cursor-not-allowed"
              >
                {applyingCoupon ? (
            ...
            {appliedCoupon && (
              <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg px-4 py-3 flex justify-between items-center">
