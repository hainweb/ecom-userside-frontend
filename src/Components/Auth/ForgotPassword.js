...
const ForgotPassword = ({ loginedUser }) => {
  ...
  const handleFormSubmit = (e) => {
    ...
    if (Mobile.length === 10) {
      axios
        .post(`${BASE_URL}/find-user`, { Mobile }, { withCredentials: true })
        .then((response) => {
  ...
  return (
    <div
      className={`min-h-screen flex items-center justify-center bg-white dark:bg-gray-800 transition-colors duration-300`}
    >
      {notification.show && (
